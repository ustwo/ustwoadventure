...
window.addEventListener("deviceorientation", e => {
    ...
    logoAdventure.style.transition = "transition: transform 4s cubic-bezier(0.6, 0, 0.5, 1);";
    logoUstwo.style.transition = "transition: transform 4s cubic-bezier(0.6, 0, 0.5, 1);";
